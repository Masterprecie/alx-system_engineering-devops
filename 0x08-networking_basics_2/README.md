...
* **1. Show attached IPs**
  * [3-show_attached_IPs](./1-show_attached_IPs): Bash script that displays all active IPv4
  IP's on the machine.

* **100. Port listening on localhost**
  * [4-port_listening_on_localhost](./100-port_listening_on_localhost): Bash script that
